...
export const RestaurantCard1 = ({
  ...
  return (
    <Card
      className=" flex flex-row justify-start space-x-2  rounded-sm h-fit p-2 shadow-none border-none hover:shadow-md hover:border-4 bg-white dark:bg-gray-500 "
      onClick={() => route.push("/resto/rest")}
    >
      <div className="relative h-26 md:h-28 w-1/2 rounded-md">
        <Image
          src={image}
          alt="Picture of the restaurant"
          layout="fill" // required
